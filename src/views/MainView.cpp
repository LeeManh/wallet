 ...
 *
 * Mục đích:
 *   Hiển thị giao diện lựa chọn để người dùng có thể đăng nhập, đăng ký hoặc
 * thoát chương trình.
 *
 * Input:
 ...
 *   - Thực hiện điều hướng sang chức năng tương ứng dựa trên lựa chọn của người
 * dùng.
 */
 ...
 *
 * Mục đích:
 *   Nhận thông tin đăng nhập, xác thực tài khoản, và điều hướng tới giao diện
 * tương ứng (quản trị hoặc khách hàng) khi đăng nhập thành công.
 *
 * Input:
